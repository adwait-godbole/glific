defmodule GlificWeb.Providers.Dialog360.Router do
  @moduledoc """
  A Dialog360 router which will redirect all the dialog360 incoming request to there controller actions.
  """

  use GlificWeb, :router

  alias GlificWeb.Providers.Dialog360.Controllers

  @doc """
  Need to match the following type specs from the dialog360 documentation
  # type
  user-event
    # payload.type
    sandbox-start
  ...
  message
    ...
    location
  """
  scope "/dialog360", Controllers do
    scope "/user-event" do
